...
const EventSystemWrapper = () => {
    useEffect(() => {
        ...
        const appTicker = Game.PIXI.app.ticker;
        appTicker.add(tickerFn);

        return () => {
            appTicker.remove(tickerFn);
        };
    }, []);

    return null; // You can return a React element here if needed
};
...
export default EventSystemWrapper;
